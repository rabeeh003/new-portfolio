                ...
                <div className="flex gap-2 mt-4" onClick={(e) => e.stopPropagation()}>
                  {project.repoUrl && (
                    <a
                      ...
                      className="flex items-center justify-center w-10 h-10 border border-gray-600 text-white hover:bg-gray-800 rounded-xl transition-colors flex-shrink-0"
                    >
                      <Github size={20} />
                    </a>
                  )}
                  <div className="flex gap-2 flex-1">
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white rounded-xl text-sm transition-colors flex-1"
                      >
                    ...
                    {project.playstoreUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl text-sm transition-colors flex-1"
                      >
                        <PlayStoreIcon />
                        Play
                      </a>
                    ...
                    {project.appstoreUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-xl text-sm transition-colors flex-1"
                      >
                        <AppStoreIcon />
                        iOS
                      </a>
