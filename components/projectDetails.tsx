...
function ProjectDetails({ project }: { project: number }) {
    ...
    return (
        <section className="relative  w-full h-fit md:flex md:px-10">
            <div className="static flex-none  top-0 h-fit md:max-w-[40%] lg:max-w-[30%] grid items-center justify-center">
                <div>
                    <Image
                        ...
                        alt={proj.Title}
                        src={proj.image || "https://app.requestly.io/delay/1000/https://nextui-docs-v2.vercel.app/images/hero-card-complete.jpeg"}
                    />
                </div>
            ...
            <div className=" w-full h-[70vh]  md:h-[470px]  scrollbar-hide overflow-y-scroll mt-10 md:-mt-10 md:pt-10 md:p-4">
                    ...
                    <div className="w-full">
                        ...
                        <div className="grid gap-1 w-full">
                            {proj.fechers.map((feature, index) => (
                                <div key={index} className="flex items-center p-2  bg-slate-100 rounded-xl dark:bg-indigo-950 w-full mb-2">
